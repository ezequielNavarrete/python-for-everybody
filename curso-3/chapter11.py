...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_927692.txt (There are 84 values and the sum ends with 166)
These links open in a new window. Make sure to save the file into the same folder as you will be 
writing your Python program. Note: Each student will have a distinct data file for 
...
handle= open("regex_sum_927692.txt")
lst=list()
for line in handle:
