...
Actual data: http://py4e-data.dr-chuck.net/comments_927696.xml (Sum ends with 29)
...
To make the code a little simpler, you can use an XPath selector string to look through the entire 
...
serviceurl = ' http://py4e-data.dr-chuck.net/comments_927696.xml'
...
suma=0
for count in counts:
    suma+=int(count.find("count").text)
print(suma)
